...
export const exit_typesSymbol = Symbol( 'Object [ activity.exit.types ] checking for arguments' )
export const exit_types = Object.defineProperty( exit[ exitSymbol ], exit_typesSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
    value: {
...
/**
 * Defining the type of activity.exit.exit_type.
 *
 * @typedef exit_types
 * @type {object}
