 ...
 * @property {string} [library] - 'static' tells to do not act for a specific library but just for static HTML files. 'react' | 'solid' | 'vue' will activate some special features for the library.
 ...
 * @property {void|string} [response_time] - given this flag the server will not stdout the response time to a incoming request.
