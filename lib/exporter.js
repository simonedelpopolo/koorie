 ...
 * @property {boolean} [silenced] - reduced the size of the log, printed & written. and response time goes shut off.
 ...
 */
export { default as routing_log__ } from './koorie/routing/log.js'
/**
