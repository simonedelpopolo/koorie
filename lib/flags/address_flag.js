...
export const addressFlagSymbol = Symbol( '--address[-a] type checking' )
export const addressFlag = Object.defineProperty( flags, addressFlagSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
...
const internal_ = addressFlag[ addressFlagSymbol ]
