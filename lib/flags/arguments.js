...
import { init, process_exit } from '../../whisk.js'
            ...
            switch ( flagsObjectKeys[ flag ] ) {
                ...
                case 'init':
                    ...
                    if( await is_json( flagsObject[ flagsObjectKeys[ flag ] ] ) === true )
                        await init( await parse( flagsObject[ flagsObjectKeys[ flag ] ] ) )
                    break
                ...
                case 'port':
                    ...
                    if( flagsObject[ flagsObjectKeys[ flag ] ] === 'random' )
                        flagsObject[ flagsObjectKeys[ flag ] ] = 'null'
                    else
                        flagsObject[ flagsObjectKeys[ flag ] ] = parseInt( flagsObject[ flagsObjectKeys[ flag ] ] )
                    continue
