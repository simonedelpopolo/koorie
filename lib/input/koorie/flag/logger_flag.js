...
export const logger_flagSymbol = Symbol( 'Object [ input.logger_flag ]' )
export const logger_flag = Object.defineProperty( input, logger_flagSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
     ...
     */
    value: async function logger_flag( option ){
        ...
        const resolvers = {
            ...
            false: async () => {
                ...
                let { quiet, write, error } = await options( option.toString(), '--logger[-l]='.green().underline() )
                ...
                logger.quiet = await loggerQuietGenerator.return( quiet )
                    .then( resolve => resolve.value )
                ...
                logger.write = await loggerWriteGenerator.return( write )
                    .then( resolve => resolve.value )
...
export default logger_flag[ logger_flagSymbol ]
