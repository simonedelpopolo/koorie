...
const middleware_flagSymbol = Symbol( 'Object [ input.middleware_flag ]' )
const middleware_flag = Object.defineProperty( input, middleware_flagSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
     ...
     *
     * - middleware_flag flag type check.
     *
     * @param {string} options - the value from the shell.
     * @throws { Error }
     * @returns {Promise<string|Error|undefined>|string|Error|undefined}
     */
    value: async function middleware_flag( options ){
...
export default middleware_flag[ middleware_flagSymbol ]
