            ...
            switch ( process_parsed_argv.keys[ flag ] ) {
                ...
                case 'experimental_log_writer':
                    ...
                    process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await experimental_log_writer_flag(
                        ...
                        .catch( async error => {
                            await process_exit( '--experimental-log-writer doesn\'t accept any argument', error, shell_exit_codes.flags )
                        } )
                ...
                case 'no_listening_check':

                    process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await no_listening_check_flag(
                        process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ]
                    )
                        .catch( async error => {
                            await process_exit( '--no-listening-check doesn\'t accept any argument', error, shell_exit_codes.flags )
                        } )
                ...
                case 'silenced':
                    ...
                    process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await silenced_flag(
                        ...
                        .catch( async error => {
                            await process_exit( '--silenced doesn\'t accept any argument', error, shell_exit_codes.flags )
                        } )
