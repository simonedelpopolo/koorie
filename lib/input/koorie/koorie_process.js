...
import { address_flag, response_time_flag } from '../../../input.js'
import { cluster_flag_get, hot_flag_get, library_flag_get, logger_flag_get, socket_flag_get } from '../../exporter.js'
        ...
        for ( const flag in process_parsed_argv.keys ) {
            ...
            switch ( process_parsed_argv.keys[ flag ] ) {
                ...
                case 'logger': {
                    ...
                    const logger = await logger_flag_get(
                        process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ]
                    )
