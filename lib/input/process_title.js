...
import { response_time_flag } from '../../input.js'
import {
    address_flag_get,
    cluster_flag_get,
    hot_flag_get,
                ...
                for ( const flag in process_parsed_argv.keys ) {
                    ...
                    switch ( process_parsed_argv.keys[ flag ] ) {
                        ...
                        case 'response_time': {
                            ...
                            process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await response_time_flag( process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] )
