            ...
            case 'koorie-shell': {
                ...
                for ( const flag in process_parsed_argv.keys ) {
                    switch ( process_parsed_argv.keys[ flag ] ) {
                        ...
                        case 'memory': {
                            delete process_parsed_argv.object.memory
                            process_parsed_argv.keys.splice( 0, 1 )
                            delete shell.command.route
                            ...
                            for ( const flag in memoryFlags ) {
                                ...
                                switch ( memoryFlags[ flag ] ) {
                                    ...
                                    case 'refresh_rate': {
                                        ...
                                        shell.command.memory.refresh_rate = process_parsed_argv.object[ memoryFlags[ flag ] ].toNumber()
                                    ...
                                    case 'socket_path':
                                        ...
                                        shell.command.memory.socket_path = process_parsed_argv.object[ memoryFlags[ flag ] ].toString()
                                        delete process_parsed_argv.object[ memoryFlags[ flag ] ]
                                        process_parsed_argv.keys.splice( 0, 1 )
                                    ...
                                    default: {
                                        ...
                                        error += `\x1b[41m        run -> ${ process.title } memory help[h]        \x1b[0m\n`
                                        await process_exit( error, new TypeError( `${ process.title } flags-error` ), shell_exit_codes.flags )
                                    }
                                }
                            }
