                    ...
                    switch ( process_parsed_argv.keys[ flag ] ) {
                        ...
                        case 'hot':
                            ...
                            process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await hot_flag_get(
                                ...
                                .catch( async error => {
                                    await process_exit__( '--hot accept only the string "false"|"true" or void.', error, shell_exit_codes__.flags )
                                } )
                        ...
                        case 'library':
                            ...
                            process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await library_flag_get(
                                ...
                                .catch( async error => {
                                    await process_exit__( '--library accept only string.', error, shell_exit_codes__.flags )
                                } )
