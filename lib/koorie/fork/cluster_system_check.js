...
const cluster_system_checkSymbol = Symbol( 'Object [ koorie.fork.cluster_system_check ]' )
const cluster_system_check = Object.defineProperty( fork, cluster_system_checkSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
     ...
     */
    value: async function* cluster_system_check( check ){
        ...
        yield await ( async () => {
            ...
            const executable_like_file = `${process.cwd()}/${process.env.EJECTED_FILE || 'koorie.js'}`
...
export default cluster_system_check[ cluster_system_checkSymbol ]
