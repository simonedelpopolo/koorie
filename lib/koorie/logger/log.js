...
const log = Object.defineProperty( logger, logSymbol, {
     ...
     *
     * @returns {Promise<{date: (Date|null), incoming: {body: {payload: null, length: null}, url_search_params: null}, headers: null, outgoing: {body: {payload: null, length: null}}, code: null, method: null, ip: null, message: null, error: null, hot: string, ssl: (Promise|PromiseFulfilledResult<boolean>|PromiseRejectedResult<string>), url: null, filename: null, connections_since: number, library_message: null, http2: boolean, socket: {path: string, active: (Promise|PromiseFulfilledResult<boolean>|PromiseRejectedResult<string>)}, worker: (string|null)}>}
     */
    value: async function logger_log(){
        ...
        return {
            ...
            filename: logger_log_value.request_filename,
