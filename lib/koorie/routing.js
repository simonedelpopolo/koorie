    ...
    value: async function routing( Incoming, Outgoing ){
        ...
        switch ( models.constructor.name ){
            ...
            case 'Number':
                ...
                response_buffer = true
                buffer = '{"error":"no route"}'.toBuffer()
            ...
            default:
                ...
                response_buffer = true
                buffer = '{"internal":"no route"}'.toBuffer()
        ...
        return new Promise( ( resolve ) => {
            ...
            if( process.env.ON_LISTENING_CHECK_REQUEST ) routing_log = { code:  Outgoing.statusCode, 'on-listening-check': true }
