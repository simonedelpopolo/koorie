...
import { body, hot, library, query, request, resource, routes } from '../../index.js'
...
export let routing = Object.defineProperty( koorie, routingSymbol, {
    ...
    value: async function routing( parameters ){
        ...
        /**
         * Basically the url requested by the browser. sliced off all the queries.
         *
         * @type {string}
         */
        let requested_resource = parameters.requested_resource.slice( 0, parameters.requested_resource.indexOf( '?' ) )
