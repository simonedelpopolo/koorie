...
const allSymbol = Symbol( 'Object [ koorie.routing.all ]' )
const all = Object.defineProperty( routing, allSymbol, {
    enumerable: true,
    writable: false,
    configurable: false,
     ...
     */
    value: async function routing_all( RouteExport, Incoming, Outgoing ) {
