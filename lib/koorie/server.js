    ...
    value: async function server( flags = null ) {
        ...
        const resolvers = {
            ...
            false: ( async () => {
                ...
                if(  await undefined_( flags.lb || flags.library ) === false )
                    process.env.LIBRARY = flags.lb || flags.library
                ...
                if ( await undefined_( flags.hot ) === false )
                    process.env.HOT = flags.hot.toString()
