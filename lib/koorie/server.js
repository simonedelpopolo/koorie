...
export const server = Object.defineProperty( koorie, serverSymbol, {
     ...
     *
     * @param {{p:string,port:string,a:string,address:string,c:string,cluster:string|object,s:string,static_files:string,false_flag:boolean|undefined, react:boolean|undefined,r:boolean|undefined}|null} flags - Parsed arguments.
    ...
    value: async function server( flags = null ) {
        ...
        process.env.static_files = flags.s || flags.static_files || 'public'
        process.env.react = flags.r || flags.react || 'false'
