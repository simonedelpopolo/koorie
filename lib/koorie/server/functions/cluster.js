 ...
 */
export async function cluster( flag, false_flag, static_files, ejected ){
            ...
            if ( await undefined_( false_flag ) === true ){
                ...
                if( await number_( flag ) === true ){
                    ...
                    if(  flag !== 0 )
                        ...
                        await fork( flag, static_files, ejected )

                    else

                        await fork( 0, static_files, ejected )
                    ...
                    if( flag.toString() === 'full' )
                        ...
                        await fork( 'full', static_files, ejected )
                }
