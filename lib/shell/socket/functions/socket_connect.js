...
/**
 * Object [ shell.socket.functions.connect ]
 * It creates a client socket connection.
 *
...
export function socket_connect( data, options, api ){
    ...
    // - todo -> this thing should have being changed sooner than yesterday.
    ...
    client.on( 'error', error => console.trace( error ) )
}
